...
const YearlyReport = () => {
  ...
  const fetchYearlyReports = async () => {
    try {
      ...
      // Use existing admin endpoint for yearly collections
      const response = await axios.get(`/api/admins/totalCollectionsYearly`);
      ...
      toast({
        title: 'Error',
        description: 'Failed to fetch yearly reports',
        status: 'error',
        duration: 5000,
        isClosable: true,
      });
    ...
    return (
      <Box display="flex" justifyContent="center" alignItems="center" minH="400px">
        <VStack spacing={4}>
          ...
          <Text>Loading yearly reports...</Text>
        </VStack>
      </Box>
    );
  }
